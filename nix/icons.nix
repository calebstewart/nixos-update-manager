  ...
  render =
    ...
    lib.concatMapStringsSep "\n" (size: ''
      resvg --stylesheet "$stylesheets/${icon.file}.css" \
        ...
        "$out/share/icons/hicolor/${toString size}x${toString size}/${icon.dir}/nixos-update-${icon.file}.png"
    '') sizes;
...
in
runCommand "nixos-update-manager-icons"
  {
    ...
    meta = {
      description = "Status and menu icons for the NixOS update manager tray";
  ...
  ''
    ...
    [Icon Theme]
    Name=Hicolor
    Comment=NixOS update manager icons
