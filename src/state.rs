...
pub use nixos_update_manager::Summary;

use nixos_update_manager::{
    human_bytes, ApplyMode, BuildPlan, InputChange, PackageChange, ReviewRequest, PROTOCOL_VERSION,
};
...
mod tests {
    use super::*;
    use nixos_update_manager::Counts;
