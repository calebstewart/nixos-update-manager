...
mod tests {
    ...
    fn parses_each_record_kind() {
        ...
        assert_eq!(
            ...
            Some(Event::Start {
                ...
                path: Some("/nix/store/abcdefghijklmnopqrstuvwxyz012345-hello-2.12.1.drv".into()),
            })
        );
        assert_eq!(
            parse_line(
        ...
        assert_eq!(
            parse_line(
                r#"@nix {"action":"msg","level":0,"msg":"\u001b[31;1merror:\u001b[0m boom"}"#
            ),
            Some(Event::Msg {
                level: 0,
    ...
    fn rejects_what_it_does_not_understand() {
        ...
        assert_eq!(
            parse_line(r#"@nix {"action":"start","id":1,"type":10"#),
            None
        );
        assert_eq!(
    ...
    fn pnames_are_cut_where_nix_cuts_them() {
        assert_eq!(
            drv_pname("/nix/store/abcdefghijklmnopqrstuvwxyz012345-python3.12-requests-2.31.0.drv"),
            "python3.12-requests"
        );
        assert_eq!(
            drv_pname(
